import {
  parseSGS
} from "./chunk-NJPSC7SH.js";
import {
  PGNotation,
  getPuzzleGeometryByName
} from "./chunk-ROGN5SXC.js";
import {
  cube2x2x2,
  puzzles
...
async function data222() {
  return parseSGS(await cube2x2x2.kpuzzle(), `SubgroupSizes 24 21 18 15 12 9 6
...
async function sgsDataMegaminx() {
  return parseSGS(await cachedMegaminxKPuzzleWithoutMO(), `SubgroupSizes 12 5 60 58 60 56 54 57 52 50 54 48 46 51 44 42 48 40 45 38 36 42 34 32 39 30 36 28 26 33 24 30 22 20 27 18 24 16 14 21 12 18 10 15 8 6 2 12 9 3
...
async function uncachedSGSDataPyraminx() {
  return parseSGS(await puzzles.pyraminx.kpuzzle(), `SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
async function uncachedSGSDataSkewb() {
  return parseSGS(await skewbKPuzzleWithoutMOCached(), `SubgroupSizes 24 6 5 12 9 3 4 9 3 3
...
//# sourceMappingURL=search-dynamic-sgs-side-events-ZTOWSMQT.js.map
